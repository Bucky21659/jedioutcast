...
//	{"+zoom", 			 -1,				-1,		-1, -1},
	...
	{"+force_jump",		-1,					-1,		-1,	-1},
	{"+force_grip",		-1,					-1,		-1,	-1},
	{"+force_lightning",-1,					-1,		-1,	-1},
	{"+force_drain",	-1,					-1,		-1,	-1},
	{"force_heal",		-1,					-1,		-1,	-1},
	{"force_speed",		-1,					-1,		-1,	-1},
	{"force_throw",		-1,					-1,		-1,	-1},
	{"force_pull",		-1,					-1,		-1,	-1},
	{"force_distract",	-1,					-1,		-1,	-1},
	{"force_rage",		-1,					-1,		-1,	-1},
...
qboolean ItemParse_flag( itemDef_t *item, int handle) 
{
	...
	{
		Com_Printf(S_COLOR_YELLOW,va("Unknown item style value '%s'",tempStr));
	}
...
qboolean MenuParse_style( itemDef_t *item, int handle) 
{
	...
	if (styles[i] == NULL)
	{
		Com_Printf(S_COLOR_YELLOW,va("Unknown menu style value '%s'",tempStr));
	}
	return qtrue;
}
