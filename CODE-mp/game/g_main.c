...
static cvarTable_t		gameCvarTable[] = {
	...
	{ &g_MaxHolocronCarry, "g_MaxHolocronCarry", "5", CVAR_SERVERINFO | CVAR_USERINFO | CVAR_LATCH, 0, qfalse  },
	...
	{ &g_forceRegenTime, "g_forceRegenTime", "500", CVAR_ARCHIVE, 0, qtrue  },
	...
	{ &g_weaponRespawn, "g_weaponrespawn", "30", 0, 0, qtrue  },
...
void CheckExitRules( void ) {
	...
	if ( g_gametype.integer < GT_CTF && g_fraglimit.integer ) {
		...
		for ( i=0 ; i< g_maxclients.integer ; i++ ) {
			...
			if ( g_gametype.integer == GT_TOURNAMENT && g_duel_fraglimit.integer && cl->sess.wins >= g_duel_fraglimit.integer-1 )
			{
